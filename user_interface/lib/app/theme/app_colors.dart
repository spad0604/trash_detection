...
class AppColors {
  ...
  static const Color binPlastic  = Color(0xFF54A0FF);  // Blue
  static const Color binOrganic  = Color(0xFF00C48C);  // Green
  static const Color binOther    = Color(0xFFFFAA2C);  // Amber
